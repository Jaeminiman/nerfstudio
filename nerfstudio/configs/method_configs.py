...
from nerfstudio.models.semantic_splatfacto import SemanticSplatfactoModelConfig
...
descriptions = {
    ...
    "semantic-splatfacto": "Semantic Gaussian Splatting model with per-Gaussian semantic features.",
}
...
# [CUSTOM] Semantic Splatfacto - Gaussian Splatting with per-Gaussian semantic features
method_configs["semantic-splatfacto"] = TrainerConfig(
    ...
    pipeline=VanillaPipelineConfig(
        datamanager=FullImageDatamanagerConfig(
            ...
            dataparser=SemanticDataParserConfig(load_3D_points=True),
            cache_images_type="uint8",
        ),
        model=SemanticSplatfactoModelConfig(
